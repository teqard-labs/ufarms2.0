    ...
    <div className="relative mx-auto w-full max-w-7xl bg-white">
      <div className="mx-auto max-w-sm sm:max-w-2xl md:max-w-none py-5 px-4 w-full">
        ...
        <div className="flex items-center justify-center">
          ...
          <h2 className="text-xl lg:text-2xl text-gray-700 font-bold font-oswald uppercase tracking-wider whitespace-nowrap">Farms </h2>
        ...
        <div className="mt-5 grid grid-cols-1 sm:grid-cols-3">
          {products.map((product, index) => (
            <a key={product.id} href={product.href} className={`col-span-1 group relative py-3 pl-4 sm:pl-8 pr-4 ${index !== 0 && "border-t-2 sm:border-t-0 sm:border-l-2 border-gray-200"} bg-white overflow-hidden`}>
              {/* ::Details */}
              ...
              {/* ::Picture */}
              <img src={product.picture} alt="" className="absolute top-1/2 right-0 h-4/5 opacity-25 md:opacity-50 lg:opacity-100 transform -translate-y-1/2 group-hover:scale-110" />
            </a>
          ))
          }
        </div>
