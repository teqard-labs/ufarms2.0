...
const Footer = () => {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5" />
          ...
          <div className="flex flex-col items-center col-span-2 px-4 pb-0 md:col-span-1 md:py-3 sm:items-start">
            ...
            <p className="text-lg font-medium text-center md:w-48 sm:text-left md:text-xl">101 Paradise Road, 97460 Fancy Island REUNION</p>
          </div>
          {/* ::Email */}
          <div className="flex flex-col items-center col-span-2 px-4 pb-0 md:col-span-1 md:py-3 sm:items-start">
            <h3 className="py-1.5 md:py-4 text-xl text-white font-bold tracking-wide">Fancy Company</h3>
